    ...
    fn bracket() {
        ...
        assert_eq!(
            ...
            &[
                ...
                t(Token::OneOf {
                    invert: false,
                    list: vec![Collation::Char(b'-'), Collation::Char(b'1')]
                }),
                c(b' '),
                t(Token::OneOf {
                    invert: false,
                    list: vec![Collation::Char(b'1'), Collation::Char(b'-')]
                })
            ]
        );
        assert_eq!(
